...
const renderAccomodationOption = ({value, label}: {value: string, label: string}) => {
...
const accomodationOptions: {value: string, label: string}[] = [
  {value: AccomodationEnum.Hajmas, label: "Hajmás"},
  {value: AccomodationEnum.Galosfa, label: "Gálosfai Vendégház"},
  {value: AccomodationEnum.NoSzallas, label: "Nem kérek szállást"}
]
        ...
        >
          ...
          <div key={index} className="flex items-center gap-2">
            ...
            <Button
              ...
              className="h-auto py-1 px-2 text-xs text-red-500"
            >
              Törlés
            </Button>
          </div>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <RadioGroup
                        ...
                        className="flex flex-col space-y-2"
                      >
                       {accomodationOptions.map((acc)=>renderAccomodationOption(acc))}
                      </RadioGroup>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
